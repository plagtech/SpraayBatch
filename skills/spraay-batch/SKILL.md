...
SpraayBatch gives an agent its own non-custodial wallet and lets it pay in USDC on
...
> Note: this scaffold ships `spraay_wallet_info` today. Payment and budget tools
